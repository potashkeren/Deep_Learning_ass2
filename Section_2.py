...
layer_max_pooling1 = create_maxPool(input=layer_conv1,
...
layer_max_pooling2 = create_maxPool(input=layer_conv2,
...
layer_fc2 = create_fullyConnected_layer(input=layer_fc1,
...
def train(num_iteration, print_every_n=250):
    for i in range(num_iteration):
        ...
        x_batch = np.reshape(batch[0], [-1, image_size, image_size, 1])
